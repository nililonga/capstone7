    ...
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                ViewBag.Date = JsonData["currentobservation"]["Date"];
                ViewBag.Wind = JsonData["currentobservation"]["Winds"];
                ViewBag.Zone = JsonData["currentobservation"]["timezone"];
                ViewBag.Place = JsonData["currentobservation"]["state"];
            }
            catch (Exception e)
            {
